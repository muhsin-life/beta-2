            ...
            <NavigationMenuItem>
              ...
              <NavigationMenuContent>
                <div className="flex flex-col gap-2 bg-white p-3 ">
                  ...
                  <Button className="text-sm h-7" size={"sm"}>View All</Button>
                  </div>
                  
                  <ul className="grid   gap-3 grid-cols-6 w-full rounded-lg">
                    {brandsData?.data.brands.map((brand) => (
                      <li>
                        <Link href={`/brand/${brand.slug}`}>
                          <div className="flex flex-col gap-1 items-center justify-center ">
                            <div className="bg-white flex items-center justify-center rounded-xl shadow hover:shadow-lg transition ">
                              <Image
